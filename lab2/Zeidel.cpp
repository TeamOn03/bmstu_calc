...
void Z_solution_search(double** A, double* b, double eps, double* x, double* x_old, double* diff, int n, double** L, double** D, double** U)
{
    int iterations = 0;
    do
    {
...
void Zeidel(double* a, double* b, double* c, double* d, int n, double* x, double* x_old, double* diff, double** L, double** D, double** U)
{
    double eps = 1e-10;
    for (int i = 0; i < n; i++) {
        x_old[i] = 0;
...
int main() {
    ...
    Z_solution_search(A, b, 1e-10, x, x_old, diff, n, L, D, U);
    ...
    Zeidel(a, b, c, d, n, x, x_old, diff, L, D, U);
    for (int i = 0; i < n; i++) {
        std::cout << x[i] << '\n';
    }
